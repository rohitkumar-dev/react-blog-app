    ...
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-full w-full">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M4 6h16M4 12h16M4 18h16" />
              ...
              <div
                ...
                }  sm:inline-block flex-grow text-sm md:text-base rounded-lg mt-3 sm:mt-0 sm:flex-grow-0 bg-red-300 sm:bg-red-100 sm:dark:bg-red-900 transition-all duration-200 ease-in-out`}
              >
